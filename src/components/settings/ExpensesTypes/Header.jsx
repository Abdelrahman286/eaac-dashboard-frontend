...
const Header = ({ data }) => {
  ...
  const handleDisabled = (e) => {
    if (disabledList?.key == "expensesTypes") {
      ...
      setDisabledList({ key: "expensesTypes" });
    }
  };
  ...
  return (
    <div className="page-actions">
      <div className="search-wrapper">
        {disabledList?.key == "expensesTypes" && (
        ...
        >
          <InputBase
            ...
            placeholder={
              disabledList?.key == "expensesTypes"
                ? "Search Deleted Expenses Types"
                : "Search Expenses Types"
            }
            inputProps={{ "aria-label": "search expenses Types" }}
