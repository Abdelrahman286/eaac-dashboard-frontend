...
const Header = ({ data }) => {
  ...
  const handleDisabled = (e) => {
    if (disabledList?.key == "paymentMethods") {
      ...
      setDisabledList({ key: "paymentMethods" });
    }
  };
  ...
  return (
    <div className="page-actions">
      <div className="search-wrapper">
        {disabledList?.key == "paymentMethods" && (
        ...
        >
          <InputBase
            ...
            placeholder={
              disabledList?.key == "paymentMethods"
                ? "Search Deleted Payment Methods"
                : "Search Payment Methods"
            }
            inputProps={{ "aria-label": "search Payment Methods" }}
      ...
      <div className="buttons">
        ...
        {hasPermission("Add Payment Method") && (
          <FormButton
